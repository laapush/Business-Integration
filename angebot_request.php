...
sendMail($notify,$dateMail, $assn, $amount, $term , $abfrage);
...
function sendMail($notify,$dateMail, $assn, $amount, $term , $abfrage) {
    ...
    if($notify != null){
        ...
        //the message
        $msg = "Hallo " .$assn .", <br><br>Du hast ein Angebot für Deine Anfrage in Höhe von <strong>" .$amount ." Euro</strong> für eine Kreditlaufzeit von <strong>" .$term . " Monaten</strong> erhalten.
